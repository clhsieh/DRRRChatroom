// Decompiled by DJ v3.7.7.81 Copyright 2004 Atanas Neshkov  Date: 2013/1/13 ¤U¤È 06:43:10
// Home Page : http://members.fortunecity.com/neshkov/dj.html  - Check often for new version!
// Decompiler options: packimports(3) 
// Source File Name:   MsgPane.java
...
public class MsgPane extends JPanel
{
    ...
    public void rearrange()
    {
        try
        {
            ...
            {
                if(blockheight > 210)
                    setPreferredSize(new Dimension(425, (int)getPreferredSize().getHeight() + 210));
                else
                    setPreferredSize(new Dimension(425, ((int)getPreferredSize().getHeight() + blockheight) - 20));
                revalidate();
            }
        }
        catch(Exception e)
